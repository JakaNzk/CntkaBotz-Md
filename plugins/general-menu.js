...
type: 'audioMessage', 
ptt: true, contextInfo:{ externalAdReply: {title: 'Stay Grateful With Your Life', body: `${pickRandom(['Never give up', 'Create By putra'])}`, sourceUrl: 'https://instagram.com/nan_sakrn', thumbnail: await (await fetch('https://telegra.ph/file/a75ed90ab8fb96ca59595.jpg')).buffer(),}} 
})
